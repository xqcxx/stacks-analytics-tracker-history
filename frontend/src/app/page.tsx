...
export default function Home() {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-7xl aui-shell aui-phase2-shell-8 aui-phase2-shell-7 aui-phase2-shell-6 aui-phase2-shell-5 aui-phase2-shell-4 aui-phase2-shell-3 aui-phase2-shell-2 aui-phase2-shell-1 flex-col gap-5 px-4 py-5 sm:gap-6 sm:px-6 lg:py-10">
      <a
        href="#live-console"
